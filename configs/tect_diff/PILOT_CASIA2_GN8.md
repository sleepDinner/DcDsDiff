...
执行修订：初始 A 在数据准备时因2张 LA 掩码被保护检查阻断，GPU未启动。当前注册运行改为 B，配置 [pilot_casia2_gn8_data2_r512_s42.json](pilot_casia2_gn8_data2_r512_s42.json)；仅增加两对图/掩码的精确哈希隔离，下面的网络、训练预算和晋级门槛保持。详情见 [DATA2 修复](PILOT_DATA2_REPAIR.md)。
